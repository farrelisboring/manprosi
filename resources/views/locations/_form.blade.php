...
<div class="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <section class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
            <div class="grid gap-5 sm:grid-cols-2">
                <div>
                    ...
                    <select class="mt-2 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-200" id="location_map_id" name="location_map_id">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea class="mt-2 block min-h-32 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-200" id="description" name="description">{{ old('description', $location?->description) }}</textarea>
                </div>
            </div>
        </section>
    </div>
    ...
    <div class="space-y-6">
        <section class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
            <h2 class="text-lg font-semibold text-gray-950">Status Ruangan</h2>
            <div class="mt-5 flex items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 px-4 py-4">
        ...
        <section class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
            <h2 class="text-lg font-semibold text-gray-950">Denah Ruangan</h2>
            <div class="mt-5">
                <label class="block text-sm font-medium text-gray-900" for="denah_image">Denah</label>
                <input
                    class="mt-2 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 file:mr-4 file:rounded-md file:border-0 file:bg-slate-100 file:px-3 file:py-2 file:text-sm file:font-medium file:text-slate-700 hover:file:bg-slate-200 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-200"
                    id="denah_image"
                    name="denah_image"
                    accept="image/*"
                    type="file"
                    ...
                    <div class="mt-4 rounded-lg border border-gray-200 bg-gray-50 p-4">
                        ...
                        <div class="mt-3 overflow-hidden rounded-lg border border-gray-200 bg-white">
                            <img
                                ...
                                src="{{ route('web.locations.denah', $location) }}"
                            >
                        </div>
                    </div>
                @endif
