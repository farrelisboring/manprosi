...
@section('page-actions')
    ...
    <a class="rounded-full bg-slate-950 px-5 py-3 text-sm font-semibold text-white transition hover:bg-slate-800" href="{{ route('web.location-maps.create') }}">Tambah Gedung</a>
@endsection
