    ...
    <section class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
        <div class="grid gap-5 sm:grid-cols-2">
            <div class="sm:col-span-2">
                <label class="block text-sm font-medium text-gray-900" for="asset_id">Aset</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-900" for="reported_by_user_id">Pelapor</label>
                ...
                <p class="mt-1 text-xs text-gray-500">TODO: Placeholder untuk sebelum implementasi Auth.</p>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-900" for="reported_at">Dilaporkan Pada</label>
                <input
            ...
            <div>
                <label class="block text-sm font-medium text-gray-900" for="resolved_at">Diselesaikan Pada</label>
                <input
                    class="mt-2 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-rose-500 focus:outline-none focus:ring-2 focus:ring-rose-200"
                    id="resolved_at"
                    name="resolved_at"
